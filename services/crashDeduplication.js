...
class CrashDeduplicationService {
    crashClusters = new Map();
    /**
     * Generate a unique fingerprint for a crash
     */
    generateFingerprint(crash) {
     ...
     */
    extractSignalFromStack(stackTrace) {
     ...
     */
    async minimizeInput(crash, testFunction) {
     ...
     */
    analyzeRootCause(crash, minimizedInput) {
     ...
     */
    inferTaintedVars(stackTrace, input) {
        const vars = [];
...
//# sourceMappingURL=crashDeduplication.js.map