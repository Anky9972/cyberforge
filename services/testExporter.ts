...
class PropertyBasedTestExportService {
   ...
   */
  private generateJestTest(testCase: TestCase, options: any): GeneratedTest {
...
`;
   ...
   */
  private generatePytestTest(testCase: TestCase, options: any): GeneratedTest {
...
`;
   ...
   */
  private generateJUnitTest(testCase: TestCase, options: any): GeneratedTest {
    const functionName = options.targetFunction || 'targetFunction';
...
`;
   ...
   */
  private generateMochaTest(testCase: TestCase, options: any): GeneratedTest {
    const functionName = options.targetFunction || 'targetFunction';
    const importPath = options.importPath || './target';
    const inputStr = this.formatInput(testCase.input, 'javascript');
...
`;
   ...
   * Generate Go test
   */
  private generateGoTest(testCase: TestCase, options: any): GeneratedTest {
    const functionName = options.targetFunction || 'TargetFunction';
...
`;
   ...
   */
  private formatInput(input: string | Buffer, language: string): string {
   ...
   */
  private generateAssertion(testCase: TestCase, framework: string): string {
