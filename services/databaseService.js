 ...
 */
export async function createProject(fileName, language) {
 ...
 */
export async function createScan(projectId, filesScanned, linesOfCode) {
    const token = getAuthToken();
 ...
 */
export async function saveAnalysisResults(projectId, scanId, reconFindings, apiFindings, vulnerabilityReport, fuzzTargets, ckgData, duration) {
    const token = getAuthToken();
