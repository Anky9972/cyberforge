...
export class CVEDatabaseIntegration {
     ...
     */
    async searchCVEs(query, context) {
            ...
            if (Array.isArray(advisories)) {
                for (const advisory of advisories.slice(0, 10)) {
                    cves.push({
                        ...
                        affectedComponents: advisory.vulnerabilities?.map((v) => `${v.package.ecosystem}:${v.package.name}`) || []
                    });
                }
            }
            return {
     ...
     */
    localCVEPatternMatching(query, context) {
...
//# sourceMappingURL=cveIntegration.js.map